...
box.schema.space.create('team_match')
...
box.space.team_match:create:index('id_match', {type = 'tree', parts = {5, 'unsigned'}}) -- Column id_match, that's id of match which team is play
